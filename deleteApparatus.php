     ...
     while ($row=mysqli_fetch_assoc($query))
      {
        ...
        ?>
           ...
           <br>
            ...
            <a class="btn btn-danger" style="margin-left: 5%"href="deleteApparatus.php?delid=<?php echo $id ?>" >Delete</a></div>
             </li>
     ...
     while ($row=mysqli_fetch_assoc($query1))
      {
        ...
        ?>
           ...
           <a class="btn btn-danger" style="margin-left: 5%"href="deleteApparatus.php?delid=<?php echo $id1 ?>" >Delete</a>
