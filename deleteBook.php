     ...
     while ($row=mysqli_fetch_assoc($query))
      {
        ...
        ?>
           ...
           <a class="btn btn-danger" style="margin-left: 5%"href="deleteBook.php?delid=<?php echo $id ?>" >Delete</a>
     </div>
             </li>
     ...
     while ($row=mysqli_fetch_assoc($query1))
      {
        ...
        ?>
           ...
           <div class="write"> <h> <?php echo $book1; ?></h></div></div>
            ...
            <a class="btn btn-danger" style="margin-left: 5%"href="deleteBook.php?delid=<?php echo $id1 ?>" >Delete</a>
     </div>
             </li>
     ...
     while ($row=mysqli_fetch_assoc($query2))
      {
        ...
        ?>
           ...
           <div class="write"> <h> <?php echo $book2; ?></h></div></div>
            ...
            <a class="btn btn-danger" style="margin-left: 5%"href="deleteBook.php?delid=<?php echo $id2 ?>" >Delete</a>
     </div>
             </li>
