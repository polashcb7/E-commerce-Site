...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
     ...
     <a class="nav-link" href="Apparatus.php?logout='1'"<?php $_SESSION['log']=1 ?> ><?php echo $_SESSION['email']; ?> </a> 
     <!-- <?php endif ?> --->
     </li>
                  </ul>
          <!---search bar ---->
  ...
  <div class="perpendicular">
    ...
    <ul class="dropdown-menu">
      <li><a href="aPhysics.php">Physics</a></li>
      <li><a href="aChemistry.php">Chemistry</a></li>
      <li><a href="aBiology.php">Biology</a></li>
