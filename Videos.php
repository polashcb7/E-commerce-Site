...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
     ...
     <a class="nav-link" href="Videos.php?logout='1'"<?php $_SESSION['log']=1 ?> ><?php echo $_SESSION['email']; ?> </a> 
     <!-- <?php endif ?> --->
     </li>
                  </ul>
          <!---search bar ---->
  ...
  <div class="perpendicular">
    ...
    <ul class="dropdown-menu">
      <li><a href="vPhysics.php">Physics</a></li>
      <li><a href="vChemistry.php">Chemistry</a></li>
      <li><a href="vBiology.php">Biology</a></li>
       <li><a href="vMathematics.php">Mathematics</a></li>
