...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index3.php">Apparatus</a></li>
      ...
      <!--- button for the navbar --->
              <li class="nav-item">
                        <a class="nav-link" href="search.php">Institutions</a>
                    </li> 

               <li class="nav-item">
                        <a class="nav-link" href="search.php">Login</a>
                    </li> 

                <li class="nav-item">
                        <a class="nav-link" href="search.php">Sign Up</a>
                    </li> 
                  </ul>
          <!---search bar ---->
...
?>
 ...
 <!---Link footer ---->
    ...
    <div class="c1 container-fluid">
        <a  href="Videos.html" ><button type="button" class="btn btn-link" style="color: white;font-size:20px ;margin-top: 30px">Join Us</button></a>
        <a  href="Videos.html" ><button type="button" class="btn btn-link" style="color: white;font-size:20px ;margin-left: 38%;margin-top: 30px;">About</button></a>
        <a  href="Videos.html" ><button type="button" class="btn btn-link" style="color: white;font-size:20px;float: right; margin-top: 30px">Contact Us</button></a>
