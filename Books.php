...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
     ...
     <a class="nav-link" href="Books.php?logout='1'"<?php $_SESSION['log']=1 ?> ><?php echo $_SESSION['email']; ?> </a> 
     <!-- <?php endif ?> --->
     </li>
